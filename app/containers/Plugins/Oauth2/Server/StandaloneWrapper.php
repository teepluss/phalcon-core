<?php
namespace App\Plugins\Oauth2\Server;
...
use App\Plugins\Oauth2\Server\Storage\Pdo\Standalone\AccessToken as AccessTokenStorage;
use App\Plugins\Oauth2\Server\Storage\Pdo\Standalone\AuthCode as AuthCodeStorage;
use App\Plugins\Oauth2\Server\Storage\Pdo\Standalone\Client as ClientStorage;
use App\Plugins\Oauth2\Server\Storage\Pdo\Standalone\RefreshToken as RefreshTokenStorage;
use App\Plugins\Oauth2\Server\Storage\Pdo\Standalone\Scope as ScopeStorage;
use App\Plugins\Oauth2\Server\Storage\Pdo\Standalone\Session as SessionStorage;
        ...
        foreach ($this->grants as $type => $grantName) {
            ...
            if ($type instanceof \League\OAuth2\Server\Grant\PasswordGrant) {
                $type->setVerifyCredentialsCallback(function ($username, $password) {
                    $user = \App\Models\Entities\Users::findFirstByEmail($username);
