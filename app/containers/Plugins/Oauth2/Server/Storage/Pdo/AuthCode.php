...
namespace App\Plugins\Oauth2\Server\Storage\Pdo;
...
use App\Plugins\Oauth2\Server\Storage\AdapterTrait;

/**
 * @property \Phalcon\Db\Adapter\Pdo\Sqlite db
 */
class AuthCode extends Plugin implements AuthCodeInterface
{
